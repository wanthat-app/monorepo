...
const meta: Meta<typeof Sidebar> = {
  title: "Admin/Sidebar",
  component: Sidebar,
  decorators: [(S) => <div className="h-[560px]"><S /></div>],
};
export default meta;
...
export const Dark: Story = {
  render: () => (
    <Sidebar theme="dark" footer={<AdminUserCard theme="dark" initials="RK" name="Roni Katz" role="Platform admin" />}>
      ...
      <SidebarNavItem theme="dark" icon={CONFIG}>Configuration</SidebarNavItem>
    </Sidebar>
  ),
};
...
export const Light: Story = {
  render: () => (
    <Sidebar theme="light" footer={<AdminUserCard theme="light" initials="RK" name="Roni Katz" role="Platform admin" />}>
      ...
      <SidebarNavItem theme="light" icon={CONFIG}>Configuration</SidebarNavItem>
    </Sidebar>
  ),
};
