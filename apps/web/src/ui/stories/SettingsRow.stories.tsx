  ...
  render: () => (
    <div className="w-[460px] overflow-hidden rounded-[18px] border border-line bg-surface">
      ...
      <SettingsRow
        ...
        trailing={<span className="rounded-full bg-accent-soft px-3 py-1 text-xs font-bold text-accent">On</span>}
      />
      <SettingsRow
        icon={CARD}
        tone="base"
        label="Payment method"
        trailing={<span className="tabular text-[13px] text-muted" dir="ltr">•••• 4821</span>}
      />
    </div>
  ),
};
