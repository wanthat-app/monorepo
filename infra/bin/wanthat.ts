...
const api = new ApiStack(app, stackName(wanthatEnv, "api"), {
  ...
  passkeyProofSecret: identity.passkeyProofSecret,
  vpc: network.vpc,
  lambdaSg: network.lambdaSg,
...
new ObservabilityStack(app, stackName(wanthatEnv, "observability"), {
  ...
  functions: [
    ...
    { label: "passkey-define", fn: identity.passkeyDefineFn },
    { label: "passkey-create", fn: identity.passkeyCreateFn },
    { label: "passkey-verify", fn: identity.passkeyVerifyFn },
  ],
  cluster: data.cluster,
