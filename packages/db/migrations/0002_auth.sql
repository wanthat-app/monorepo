-- 0002_auth — link the customer (PII) row to its Cognito user (ADR-0006).
--
...
-- retries. NOT NULL by design (fail-fast, ADR-0006): every customer is provisioned with its Cognito
