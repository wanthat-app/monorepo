...
/**
 * Repository over `passkey_credential` (ADR-0006) — the public keys of members' discoverable passkeys,
...
export interface PasskeyCredentialItem {
   ...
   * (ADR-0006) mints tokens via `Cognito.passkeyCustomAuth(cognitoUsername, proof)`, so we carry
